      ...
      <CardContent className="p-5 pt-2 space-y-4">
        <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Local Temperature</p>
              <p className="text-sm font-black text-slate-700">32°C - High Humidity</p>
            </div>
          </div>
          <div className="text-right">
            <span className="text-[9px] font-bold px-2 py-0.5 bg-rose-50 text-rose-600 rounded-full">HOT</span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <motion.div 
            whileHover={{ x: 5 }}
            className="p-3 border border-slate-100 rounded-xl bg-white hover:border-primary/20 transition-all cursor-default"
          >
            <div className="flex items-center gap-2 mb-1">
              <TrendingUp size={14} className="text-emerald-500" />
              <span className="text-xs font-bold text-slate-700">Stock Jasmine Rice</span>
            </div>
